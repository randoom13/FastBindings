...
namespace FastBindings
{
    internal class AsyncFastBindingUpdateManager
    {
        ...
        private NotificationProxy<IBaseNotificationFilter> _notificationProxy = new NotificationProxy<IBaseNotificationFilter>();
        ...
        public void ApplyTargets(DependencyObject targetObject, DependencyProperty targetProperty)
        {
        ...
        public void Initialize(object sender, CacheStrategy cacheStrategy)
        {
            ...
            var frameworkElement = targetContextObject as FrameworkElement;
