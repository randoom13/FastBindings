...
namespace FastBindings.BindingManagers
{
    internal class TargetInfo
    {
        ...
        private const char ObserverBorder = '-';
        ...
        public string ObserverTarget
        {
            get
            {
                ...
                {
                    bool hasObserver = !string.IsNullOrEmpty(Target) && Target.Length > 2 && Target[0] == ObserverBorder
                     && Target[Target.Length - 1] == ObserverBorder;
