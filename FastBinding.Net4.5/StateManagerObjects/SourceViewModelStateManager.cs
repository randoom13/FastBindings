...
namespace FastBindings.StateManagerObjects
{
    ...
    {
        event EventHandlerEx<object> PropertyUpdated;
    ...
    internal class SourceViewModelStateManager : ISourceStateManager, IAsyncSourceStateManager
    {
        ...
        public SourceViewModelStateManager(string propertyName, DependencyObject targetObject,
        ...
        private void OnPropertyChanged(ViewModelPropertyInfo finalPropertyInfo)
        {
            ...
            {
                System.Diagnostics.Debug.Write($"[FastBinding] An error occurred to {finalPropertyInfo.Name} from {finalPropertyInfo.Accessor}");
        ...
        public void Subscribe(object dataContext)
        {
            ...
            var finalPropertyInfo = subscribers.Last();
            _handlerArgs = new SubcriberHandlerArgs(this, finalPropertyInfo);
